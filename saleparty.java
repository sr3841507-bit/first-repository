...
class saleparty extends JInternalFrame implements ActionListener
{
Connection con;
...
String s="insert into sparty values('"+t1.getText()+"','"+t2.getText()+"','"+t3.getText()+"','"+t4.getText()+"')";
...
{
    Statement stmt = con.createStatement();
    String s = "update sparty set address='"+t2.getText()+"', phone='" +t3.getText()+"', clbalance='" +t4.getText() +"' where name='" + t1.getText()+"'";
    stmt.executeUpdate(s);
...
Statement stmt = con.createStatement();
String s = "delete from sparty where name='"+t1.getText()+"'";
...
Statement stmt=con.createStatement();
String s2="select * from sparty where name='"+t5.getText()+"'";
