...
class receivedetails extends JInternalFrame  
{
JTable t;
JLabel l1 ;
...
String col[]=new String[]{"SERIAL NO.","PARTY NAME","RECEIVING DATE","AMOUNT","DETAILS"};
Class.forName("com.mysql.jdbc.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost/user","root","");
Statement stmt=con.createStatement();
ResultSet rs=stmt.executeQuery("Select* from receive");
int i=0;
while(rs.next())
{
...
l1=new JLabel("RECEIVING DETAILS");
l1.setFont(font1);
