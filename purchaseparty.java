...
class purchaseparty extends JInternalFrame implements ActionListener
{
Connection con;
...
String s="insert into pparty values('"+t1.getText()+"','"+t2.getText()+"','"+t3.getText()+"','"+t4.getText()+"')";
...
{
    Statement stmt = con.createStatement();
    String s = "update pparty set address='" + t2.getText() + "', phone='" + t3.getText() + "', opbalance='" + t4.getText() + "' where name='" + t1.getText() + "'";
    stmt.executeUpdate(s);
...
Statement stmt = con.createStatement();
String s = "delete from pparty where name='"+t1.getText()+"'";
...
Statement stmt=con.createStatement();
String s2="select * from pparty where name='"+t5.getText()+"'";
